(() => {
  ...
  var map4 = /* @__PURE__ */ map(functorLazy);
  ...
  var foldableList = {
    foldr: function(op) {
      return function(z) {
        return function(xs) {
          var rev3 = foldl(foldableList)(flip(cons))(nil);
          return foldl(foldableList)(flip(op))(z)(rev3(xs));
        };
      };
    },
    foldl: function(op) {
    ...
    foldMap: function(dictMonoid) {
      ...
      var mempty2 = mempty(dictMonoid);
      return function(f) {
        return foldl(foldableList)(function(b2) {
          return function(a2) {
    ...
    return {
      show: function(xs) {
        return "(fromFoldable [" + (function() {
          ...
          ;
          if (v instanceof Cons) {
            return show6(v.value0) + foldl12(function(shown) {
              return function(x$prime) {
                return shown + ("," + show6(x$prime));
              };
            })("")(v.value1);
          }
          ;
  ...
  var listMap = function(f) {
    var chunkedRevMap = function($copy_chunksAcc) {
      return function($copy_v) {
        ...
        function $tco_loop(chunksAcc, v) {
          if (v instanceof Cons2 && (v.value1 instanceof Cons2 && v.value1.value1 instanceof Cons2)) {
            $tco_var_chunksAcc = new Cons2(v, chunksAcc);
            $copy_v = v.value1.value1.value1;
            return;
          }
          ;
          var unrolledMap = function(v1) {
            if (v1 instanceof Cons2 && (v1.value1 instanceof Cons2 && v1.value1.value1 instanceof Nil2)) {
              return new Cons2(f(v1.value0), new Cons2(f(v1.value1.value0), Nil2.value));
            }
            ;
            if (v1 instanceof Cons2 && v1.value1 instanceof Nil2) {
              return new Cons2(f(v1.value0), Nil2.value);
            }
            ;
            return Nil2.value;
          };
          var reverseUnrolledMap = function($copy_v1) {
            return function($copy_acc) {
              ...
              function $tco_loop2(v1, acc) {
                if (v1 instanceof Cons2 && (v1.value0 instanceof Cons2 && (v1.value0.value1 instanceof Cons2 && v1.value0.value1.value1 instanceof Cons2))) {
                  $tco_var_v1 = v1.value1;
                  $copy_acc = new Cons2(f(v1.value0.value0), new Cons2(f(v1.value0.value1.value0), new Cons2(f(v1.value0.value1.value1.value0), acc)));
                  return;
                }
                ;
                $tco_done1 = true;
    ...
    return chunkedRevMap(Nil2.value);
  };
  var functorList2 = {
    map: listMap
  };
  var foldableList2 = {
    foldr: function(f) {
      return function(b2) {
        var rev3 = function() {
            ...
            return function($copy_v) {
              ...
              function $tco_loop(acc, v) {
                ...
                if (v instanceof Cons2) {
                  $tco_var_acc = new Cons2(v.value0, acc);
                  $copy_v = v.value1;
                  return;
                }
                ;
          ...
          return go2(Nil2.value);
        }();
        var $281 = foldl(foldableList2)(flip(f))(b2);
        return function($282) {
          return $281(rev3($282));
        };
      };
    ...
    foldMap: function(dictMonoid) {
      ...
      var mempty2 = mempty(dictMonoid);
      return function(f) {
        return foldl(foldableList2)(function(acc) {
  ...
  var foldr2 = /* @__PURE__ */ foldr(foldableList2);
  var semigroupList = {
    append: function(xs) {
      return function(ys) {
        return foldr2(Cons2.create)(ys)(xs);
      };
    }
  };
  ...
  var cons3 = function(y) {
    return function(v) {
      return new NonEmpty(y, new Cons2(v.value0, v.value1));
    };
  };

  // output/Data.List.Lazy/index.js
  var unfoldr2 = /* @__PURE__ */ unfoldr(unfoldableList);
  var range3 = function(start2) {
    return function(end) {
      ...
      if (otherwise) {
        ...
        return unfoldr2(f)(start2);
      }
      ;
      throw new Error("Failed pattern match at Data.List.Lazy (line 148, column 1 - line 148, column 32): " + [start2.constructor.name, end.constructor.name]);
    };
  };
          ...
          return function($copy_v1) {
            ...
            function $tco_loop(ctx, v1) {
              ...
              if (v1 instanceof Two) {
                ...
                ;
                if (v2 instanceof LT) {
                  $tco_var_ctx = new Cons2(new TwoLeft(v1.value1, v1.value2, v1.value3), ctx);
                  $copy_v1 = v1.value0;
                  return;
                }
                ;
                $tco_var_ctx = new Cons2(new TwoRight(v1.value0, v1.value1, v1.value2), ctx);
                $copy_v1 = v1.value3;
                return;
              }
              ;
              if (v1 instanceof Three) {
                ...
                ;
                if (v3 instanceof LT) {
                  $tco_var_ctx = new Cons2(new ThreeLeft(v1.value1, v1.value2, v1.value3, v1.value4, v1.value5, v1.value6), ctx);
                  $copy_v1 = v1.value0;
                  return;
                }
                ;
                if (v3 instanceof GT && v4 instanceof LT) {
                  $tco_var_ctx = new Cons2(new ThreeMiddle(v1.value0, v1.value1, v1.value2, v1.value4, v1.value5, v1.value6), ctx);
                  $copy_v1 = v1.value3;
                  return;
                }
                ;
                $tco_var_ctx = new Cons2(new ThreeRight(v1.value0, v1.value1, v1.value2, v1.value3, v1.value4, v1.value5), ctx);
                $copy_v1 = v1.value6;
                return;
              }
              ;
      ...
      var up = function($copy_ctxs) {
        return function($copy_tree) {
          ...
          function $tco_loop(ctxs, tree) {
            if (ctxs instanceof Nil2) {
              $tco_done = true;
              return tree;
            }
            ;
            if (ctxs instanceof Cons2) {
      ...
      var removeMaxNode = function($copy_ctx) {
        return function($copy_m) {
          ...
          function $tco_loop(ctx, m) {
            ...
            ;
            if (m instanceof Two) {
              $tco_var_ctx = new Cons2(new TwoRight(m.value0, m.value1, m.value2), ctx);
              $copy_m = m.value3;
              return;
            }
            ;
            if (m instanceof Three && (m.value0 instanceof Leaf && (m.value3 instanceof Leaf && m.value6 instanceof Leaf))) {
              $tco_done1 = true;
              return up(new Cons2(new TwoRight(Leaf.value, m.value1, m.value2), ctx))(Leaf.value);
            }
            ;
            if (m instanceof Three) {
              $tco_var_ctx = new Cons2(new ThreeRight(m.value0, m.value1, m.value2, m.value3, m.value4, m.value5), ctx);
              $copy_m = m.value6;
              return;
            }
            ;
          ...
          function $tco_loop(ctx, m) {
            ...
            if (m instanceof Two) {
              ...
              if (v instanceof EQ) {
                ...
                $tco_done3 = true;
                return new Just(new Tuple(m.value2, removeMaxNode(new Cons2(new TwoLeft(max6.key, max6.value, m.value3), ctx))(m.value0)));
              }
              ;
              if (v instanceof LT) {
                $tco_var_ctx = new Cons2(new TwoLeft(m.value1, m.value2, m.value3), ctx);
                $copy_m = m.value0;
                return;
              }
              ;
            ...
            if (m instanceof Three) {
              ...
              if (v3 instanceof EQ) {
                var max6 = maxNode(m.value0);
                $tco_done3 = true;
                return new Just(new Tuple(m.value2, removeMaxNode(new Cons2(new ThreeLeft(max6.key, max6.value, m.value3, m.value4, m.value5, m.value6), ctx))(m.value0)));
              }
              ;
              if (v instanceof EQ) {
                var max6 = maxNode(m.value3);
                $tco_done3 = true;
                return new Just(new Tuple(m.value5, removeMaxNode(new Cons2(new ThreeMiddle(m.value0, m.value1, m.value2, max6.key, max6.value, m.value6), ctx))(m.value3)));
              }
              ;
              if (v3 instanceof LT) {
                $tco_var_ctx = new Cons2(new ThreeLeft(m.value1, m.value2, m.value3, m.value4, m.value5, m.value6), ctx);
                $copy_m = m.value0;
                return;
              }
              ;
              if (v3 instanceof GT && v instanceof LT) {
                $tco_var_ctx = new Cons2(new ThreeMiddle(m.value0, m.value1, m.value2, m.value4, m.value5, m.value6), ctx);
                $copy_m = m.value3;
                return;
              }
              ;
  ...
  // output/Data.Subject/index.js
  var genericShowArgsArgument2 = /* @__PURE__ */ genericShowArgsArgument(showInt);
  ...
  var Theory = /* @__PURE__ */ function() {
    function Theory2(value0) {
      this.value0 = value0;
    }
    ;
    Theory2.create = function(value0) {
      return new Theory2(value0);
    };
    return Theory2;
  }();
  var Practice = /* @__PURE__ */ function() {
    function Practice2(value0) {
      this.value0 = value0;
    }
    ;
    Practice2.create = function(value0) {
      return new Practice2(value0);
    };
    return Practice2;
  }();
  var TheoryWithPractice = /* @__PURE__ */ function() {
    function TheoryWithPractice2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    TheoryWithPractice2.create = function(value0) {
      return function(value1) {
        return new TheoryWithPractice2(value0, value1);
      };
    };
    return TheoryWithPractice2;
  }();
  ...
  var SelectiveMajor = /* @__PURE__ */ function() {
    function SelectiveMajor2() {
    }
    ;
    SelectiveMajor2.value = new SelectiveMajor2();
    return SelectiveMajor2;
  }();
  var Mandatory = /* @__PURE__ */ function() {
    function Mandatory2() {
    }
    ;
    Mandatory2.value = new Mandatory2();
    return Mandatory2;
  }();
  ...
  var LectureTime = /* @__PURE__ */ function() {
    function LectureTime2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    LectureTime2.create = function(value0) {
      return function(value1) {
        return new LectureTime2(value0, value1);
      };
    };
    return LectureTime2;
  }();
  var Freshman = /* @__PURE__ */ function() {
    function Freshman2() {
    }
    ;
    Freshman2.value = new Freshman2();
    return Freshman2;
  }();
  var Sophomore = /* @__PURE__ */ function() {
    function Sophomore2() {
    }
    ;
    Sophomore2.value = new Sophomore2();
    return Sophomore2;
  }();
  ...
  var genericTime_ = {
    to: function(x) {
      if (x instanceof Inl) {
        return new Theory(x.value0);
      }
      ;
      if (x instanceof Inr && x.value0 instanceof Inl) {
        return new Practice(x.value0.value0);
      }
      ;
      if (x instanceof Inr && x.value0 instanceof Inr) {
        return new TheoryWithPractice(x.value0.value0.value0, x.value0.value0.value1);
      }
      ;
      throw new Error("Failed pattern match at Data.Subject (line 46, column 1 - line 46, column 31): " + [x.constructor.name]);
    },
    from: function(x) {
      if (x instanceof Theory) {
        return new Inl(x.value0);
      }
      ;
      if (x instanceof Practice) {
        return new Inr(new Inl(x.value0));
      }
      ;
      if (x instanceof TheoryWithPractice) {
  ...
  var showTime = {
    show: /* @__PURE__ */ genericShow(genericTime_)(/* @__PURE__ */ genericShowSum(/* @__PURE__ */ genericShowConstructor2({
    ...
    }))(/* @__PURE__ */ genericShowConstructor(/* @__PURE__ */ genericShowArgsProduct(genericShowArgsArgument2)(genericShowArgsArgument2))({
      reflectSymbol: function() {
        return "TheoryWithPractice";
      }
    }))))
  };
  var genericSubjectType_ = {
    to: function(x) {
      if (x instanceof Inl) {
        return Major.value;
      }
      ...
      ;
      throw new Error("Failed pattern match at Data.Subject (line 22, column 1 - line 22, column 38): " + [x.constructor.name]);
    },
    from: function(x) {
      ...
      ;
      if (x instanceof SelectiveMajor) {
        return new Inr(new Inl(NoArguments.value));
      }
      ;
      if (x instanceof Mandatory) {
  ...
  var showSubjectType = {
    show: /* @__PURE__ */ genericShow(genericSubjectType_)(/* @__PURE__ */ genericShowSum(/* @__PURE__ */ genericShowConstructor1({
      reflectSymbol: function() {
        return "Major";
      }
  ...
  var genericLectureTime_ = {
    to: function(x) {
      return new LectureTime(x.value0, x.value1);
    },
    from: function(x) {
  ...
  var showLectureTime = {
    show: /* @__PURE__ */ genericShow(genericLectureTime_)(/* @__PURE__ */ genericShowConstructor(/* @__PURE__ */ genericShowArgsProduct(/* @__PURE__ */ genericShowArgsArgument(showWeekday))(genericShowArgsArgument2))({
      reflectSymbol: function() {
        return "LectureTime";
      }
    }))
  ...
  var genericGrade_ = {
    to: function(x) {
      if (x instanceof Inl) {
        return Freshman.value;
      }
      ;
      if (x instanceof Inr && x.value0 instanceof Inl) {
        return Sophomore.value;
      }
      ;
      if (x instanceof Inr && (x.value0 instanceof Inr && x.value0.value0 instanceof Inl)) {
        return Junior.value;
      ...
      ;
      throw new Error("Failed pattern match at Data.Subject (line 39, column 1 - line 39, column 32): " + [x.constructor.name]);
    },
    from: function(x) {
      if (x instanceof Freshman) {
        return new Inl(NoArguments.value);
      }
      ;
      if (x instanceof Sophomore) {
        return new Inr(new Inl(NoArguments.value));
      }
      ;
  ...
  var showGrade = {
    show: /* @__PURE__ */ genericShow(genericGrade_)(/* @__PURE__ */ genericShowSum(/* @__PURE__ */ genericShowConstructor1({
      reflectSymbol: function() {
        return "Freshman";
      }
    }))(/* @__PURE__ */ genericShowSum(/* @__PURE__ */ genericShowConstructor1({
  ...
  var ex1 = /* @__PURE__ */ function() {
    return {
      subjectType: SelectiveMajor.value,
      grade: Senior.value,
      name: "\uD1A0\uC9C0\uACBD\uC81C\uD559",
      id: "02691-01",
      point: 3,
      time: new Theory(3),
      lectureTimes: map1(LectureTime.create(Monday.value))(range3(7)(9)),
      quota: 36,
      open: false
    };
  }();
    ...
    return function(fStack) {
      return function(vals) {
        return function(gVal) {
          if (fStack instanceof Nil2) {
            return new Left(gVal);
          }
          ;
          if (fStack instanceof Cons2) {
            var gRes = apply2(fStack.value0.func)(gVal);
            var $31 = fStack.value0.count === 1;
            if ($31) {
              if (fStack.value1 instanceof Nil2) {
            ...
            ;
            if (vals instanceof Nil2) {
              return new Left(gRes);
            }
            ;
            if (vals instanceof Cons2) {
              return new Right(new Tuple(new Cons2({
                func: gRes,
  ...
  var foldFreeAp = function(dictApplicative) {
    ...
    return function(nat) {
      return function(z) {
        ...
        return go2(new Tuple(Nil2.value, singleton5(z)));
      };
    };
  };
  ...
  var uncons3 = function($copy_v) {
    ...
    var $tco_result;
    function $tco_loop(v) {
      if (v.value0 instanceof Nil2 && v.value1 instanceof Nil2) {
        $tco_done = true;
        return Nothing.value;
      }
      ;
      if (v.value0 instanceof Nil2) {
        $copy_v = new CatQueue(reverse2(v.value1), Nil2.value);
        return;
      }
      ;
      if (v.value0 instanceof Cons2) {
        $tco_done = true;
  ...
  var snoc3 = function(v) {
    return function(a2) {
      return new CatQueue(v.value0, new Cons2(a2, v.value1));
    };
  };
  ...
  var empty5 = /* @__PURE__ */ function() {
    return new CatQueue(Nil2.value, Nil2.value);
  }();
          ...
          return function($copy_ys) {
            ...
            function $tco_loop(xs, ys) {
              ...
              if (v instanceof Just) {
                ...
                $copy_ys = new Cons2(k(v.value0.value0), ys);
                return;
              }
              ;
  ...
  var pure3 = /* @__PURE__ */ pure(applicativeHalogenM);
    ...
    return function(v) {
      ...
      if (v instanceof Query) {
        return unCoyoneda(function(g) {
          var $45 = map8(maybe(v.value1(unit))(g));
          return function($46) {
  ...
  var defaultEval = /* @__PURE__ */ function() {
    return {
      handleAction: $$const(pure3(unit)),
      handleQuery: $$const(pure3(Nothing.value)),
  ...
  // output/Components.Main/index.js
  var map9 = /* @__PURE__ */ map(functorArray);
  var show2 = /* @__PURE__ */ show(showSubjectType);
  var show1 = /* @__PURE__ */ show(showGrade);
  var show22 = /* @__PURE__ */ show(showInt);
  var show3 = /* @__PURE__ */ show(showTime);
  var show4 = /* @__PURE__ */ show(/* @__PURE__ */ showList(showLectureTime));
  var show5 = /* @__PURE__ */ show(showBoolean);
  var render = function(v) {
    return div_(singleton2(table_(map9(tr_)([map9(function($12) {
      return th_(singleton2(text($12)));
    })(["\uAD6C\uBD84", "\uD559\uB144", "\uAD50\uACFC\uBAA9\uBA85", "\uACFC\uBAA9\uCF54\uB4DC", "\uD559\uC810", "\uACFC\uBAA9\uAD6C\uBD84 \uBC0F \uC2DC\uAC04", "\uAC15\uC88C\uC2DC\uAC04", "\uC815\uC6D0", "\uD0C0\uD559\uACFC\uC218\uAC15 \uAC00\uB2A5\uC5EC\uBD80"]), map9(function($13) {
      return td_(singleton2(text($13)));
    })([show2(v.subject.subjectType), show1(v.subject.grade), v.subject.name, v.subject.id, show22(v.subject.point), show3(v.subject.time), show4(v.subject.lectureTimes), show22(v.subject.quota), show5(v.subject.open)])]))));
  };
  var mainComponent = /* @__PURE__ */ mkComponent({
    "eval": /* @__PURE__ */ mkEval(defaultEval),
    initialState: /* @__PURE__ */ $$const({
      subject: ex1
    }),
    render
  });
      ...
      return function(handler2) {
        return function(lchs) {
          return function __do2() {
            ...
            var pendingQueries = $$new(new Just(Nil2.value))();
            var pendingOuts = $$new(new Just(Nil2.value))();
  ...
  var traverse_22 = /* @__PURE__ */ traverse_12(foldableList2);
  var fork3 = /* @__PURE__ */ fork(monadForkAff);
  var parSequence_2 = /* @__PURE__ */ parSequence_(parallelAff)(foldableList2);
  ...
  var queueOrRun = function(ref2) {
    return function(au) {
      return bind12(liftEffect4(read(ref2)))(function(v) {
        ...
        ;
        if (v instanceof Just) {
          return liftEffect4(write(new Just(new Cons2(au, v.value0)))(ref2));
        }
        ;
  ...
  var handleLifecycle = function(lchs) {
    return function(f) {
      return discard1(liftEffect4(write({
        initializers: Nil2.value,
        finalizers: Nil2.value
      })(lchs)))(function() {
  ...
  var traverse_5 = /* @__PURE__ */ traverse_(applicativeAff)(foldableList2);
  ...
  var parSequence_3 = /* @__PURE__ */ parSequence_(parallelAff)(foldableList2);
          ...
          return function(preInits) {
            return unDriverStateX(function(st) {
              ...
              return modify_(function(handlers) {
                return {
                  initializers: new Cons2(discard22(parSequence_3(reverse2(handlers.initializers)))(function() {
                    ...
                    var $$var2 = function() {
                        ...
                        unDriverStateX(function(st) {
                          return function __do3() {
                            flip(write)(st.handlerRef)(function() {
                              var $64 = maybe(pure1(unit))(handler2);
                              return function($65) {
                      ...
                      if (childrenIn instanceof Nothing) {
                        return runComponent(lchs)(function() {
                          var $66 = maybe(pure1(unit))(handler2);
                          return function($67) {
        ...
        var render2 = function(lchs) {
          return function($$var2) {
            return function __do2() {
              ...
              when2(shouldProcessHandlers)(write(new Just(Nil2.value))(v.pendingHandlers))();
              ...
              return when2(shouldProcessHandlers)(flip(tailRecM3)(unit)(function(v1) {
                return function __do3() {
                  ...
                  write(new Just(Nil2.value))(v.pendingHandlers)();
            ...
            return function __do2() {
              ...
              modify_(function(handlers) {
                return {
                  ...
                  finalizers: new Cons2(f, handlers.finalizers)
                };
              })(lchs)();
  ...
  var main2 = /* @__PURE__ */ launchAff_(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return $$void7(runUI2(mainComponent)(unit)(body2));
  }));
